 ...
 */
class AnnotationProcessorOriginal {
     ...
     */
    AnnotationProcessorOriginal(ProcessorContext processorContext) {
...
//            uri = new Uri(authority, uriPathAndQuery, logger);
    ...
    private boolean validateClassIsAnnotatedWithAuthority(Element method, Element methodEnclosingClass) {
        ...
        if (methodEnclosingClass.getAnnotation(ContentProviderDelegate.class) == null) {
