...
public class ProcessorContinuation {
	 ...
	 */
	public void loadContinuation() throws IOException {
		FileObject continuationDelegateIndexFile = filer.getResource(StandardLocation.SOURCE_OUTPUT,
		        PersistenceAnnotationProcessor.NUDROID_PERSISTENCE_BASE_PACKAGE,
	...
	public Set<? extends Element> loadDelegateElements(Elements elementUtils) {
